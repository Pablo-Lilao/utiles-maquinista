...
var indSings = [
    ...
    { name: "FI10C - Pág. 63", text: "Postes kilométricos y hectométricos. Se coloca al inicio de un cambio de kilometraje, en este caso de vía general a vía de apartado. Los números indican, por orden decreciente de tamaño, el kilómetro, el hectómetro y los metros. Además, en el interior de un recuadro figura, el número de la vía y la denominación de la línea."},
    { name: "FI10D - Pág. 63", text: "Postes kilométricos y hectométricos. Se coloca al inicio de un cambio de kilometraje, en este caso de vía de apartado a vía general. Los números indican, por orden decreciente de tamaño, el kilómetro, el hectómetro y los metros. Además, en el interior de un recuadro figura, el número de la vía y la denominación de la línea."},
...
var elecSings = [
    { name: "FI14A - Pág. 65", text: "Solo para trenes de tracción eléctrica: Ordena parar ante ella sin rebasarla."},
    { name: "FI14B - Pág. 65", text: "Solo para trenes de tracción eléctrica: Ordena parar ante ella sin rebasarla, cuando el itinerario está orientado en la dirección de la flecha."},
    { name: "FI14C - Pág. 65", text: "Solo para trenes de tracción eléctrica: Ordena cerrar parcialmente el regulador al paso por el seccionamiento de lámina de aire de la línea de contacto."},
    { name: "FI14D - Pág. 65", text: "Solo para trenes de tracción eléctrica: Ordena cerrar totalmente el regulador al paso por el aislador de sección de la línea de contacto y no estacionar en él."},
    { name: "FI14E - Pág. 65", text: "Solo para trenes de tracción eléctrica: Ordena bajar los pantógrafos a su paso hasta pasar por la señal de elevación de pantógrafos."},
    { name: "FI14F - Pág. 65", text: "Solo para trenes de tracción eléctrica: Indica que se puede elevar el pantógrafo a su paso por ella."},
    { name: "FI14G - Pág. 65", text: "Solo para trenes de tracción eléctrica: Indica que a la distancia de 500 m se encuentra la señal de principio de zona neutra o la de bajada de pantógrafos."},
    { name: "FI14H - Pág. 65", text: "Solo para trenes de tracción eléctrica: Proximidad de principio de zona neutra. A la distancia de 500 m se encuentra la señal de principio de zona neutra. (Alta velocidad)"},
    { name: "FI14I - Pág. 65", text: "Solo para trenes de tracción eléctrica: Indica el principio de zona neutra de la línea de contacto. Ordena abrir el disyuntor hasta la señal de fin de la zona neutra."},
    { name: "FI14J - Pág. 65", text: "Solo para trenes de tracción eléctrica: Indica el final de la zona neutra de la línea de contacto. Permite cerrar el disyuntor, una vez rebasada la misma."},
    { name: "FI14K - Pág. 65", text: "Solo para trenes de tracción eléctrica: Indica que la tensión de la línea de contacto pasa de 3000 V c.c a 25000 V c.a ."},
    { name: "FI14L - Pág. 65", text: "Solo para trenes de tracción eléctrica: Indica que la tensión de la línea de contacto pasa de 25000 V c.a a 3000 V c.c ."},
]
var cartelSings = [
    ...
    { name: "FI15AG - Pág. 69", text: "Se coloca a la distancia de frenado de la boca del túnel. Indica gálibro restringido en túnel. Informa que determinados trenes están afectados por prescripciones especiales y permanentes de circulación, debido a su inscripción en gálibo. El Personal de conducción cumplimentará las limitaciones de velocidad quele hayan sido notificadas por este motivo. La falta del cartelón no exime del cumplimiento de dichas limitaciones."},
...
var velSings = [
    ...
    { name: "FVL3A - Pág. 77", text: "Limitación temporal de velocidad máxima. Ordena no exceder la velocidad indicada (en km/h), entre esta señal y la señal de fin de limitación temporal de velocidad máxima."},
    { name: "FVL3A - Pág. 77", text: "Limitación temporal de velocidad máxima. Ordena no exceder la velocidad indicada (en km/h), entre esta señal y la señal de fin de limitación temporal de velocidad máxima.(Supone CSV)"},
