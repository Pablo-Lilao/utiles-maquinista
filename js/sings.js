...
var cartelSings = [
    ...
    { name: "FI14AB - Pág. 68", text: "Indica proximidad a un cambio de signo de la rasante en un túnel."},
    { name: "FI14AC - Pág. 68", text: "Indica cambio de rasante en túnel. Marca el punto donde cambia el signo de la rasante, de cara a una eventual circulación del tren por gravedad."},
    { name: "FI14AD - Pág. 68", text: "Indica cambio de ancho de vía. Marca el inicio de la transición del ancho 1668 a 1435 mm."},
    { name: "FI14AE - Pág. 68", text: "Indica cambio de ancho de vía. Marca el inicio de la transición del ancho 1435 a 1668 mm."},
    { name: "FI14AF - Pág. 69", text: "Indica cambio de modo ASFA. Marca el punto donde debe efectuarse el cambio de modo ASFA, pudiendo efectuarse en movimiento."},
    { name: "FI14AG - Pág. 69", text: "Se coloca a la distancia de frenado de la boca del túnel. Indica gálibro restringido en túnel. Informa que determinados trenes están afectados por prescripciones especiales y permanentes de circulacióbn, debido a su inscripción en gálibo. Ek Personal de conducción cumplimentará las limitaciones de velocidad quele hayan sido notificadas por este motivo. La falta del cartelón no exime del cumplimiento de dichas limitaciones."},
    { name: "FI14AH - Pág. 69", text: "Indica distancia a final de velocidad limitada o a final de zona neutra. Marca el punto desde donde un tren de longitud inferior a 200 m, puede reanudar su marcha normal, después de haber atravesado una zona de limitación de velocidad máxima o un cambio orientado a vía desviada a menos de 200 km/h, o una zona neutra. Si hay varios cambios, la señal se coloca a la distancia del último del grupo afectado por la limitación"},
    { name: "FI14AI - Pág. 69", text: "Indica distancia a final de velocidad limitada o a final de zona neutra. Marca el punto desde donde un tren de longitud inferior a 400 m, puede reanudar su marcha normal, después de haber atravesado una zona de limitación de velocidad máxima o un cambio orientado a vía desviada a menos de 400 km/h, o una zona neutra. Si hay varios cambios, la señal se coloca a la distancia del último del grupo afectado por la limitación"},
    { name: "FI14AJ - Pág. 69", text: "Indica límite entre gestores de infraestrucutra. Marca el punto a partir del cual deja de aplicarse la normativa de circulación de un gestor de infraestructura y empieza a aplicarse la de otro."},
    { name: "FI14AK - Pág. 69", text: "Indica la vía la que dan sus indicaciones las señales instaladas en lugar que puedan ofrecer duda. Se instalan en el mástil de las señales."},
    { name: "FI14AL - Pág. 69", text: "Indica la vía la que dan sus indicaciones las señales instaladas en lugar que puedan ofrecer duda. Se instalan en el mástil de las señales."},
    { name: "FI14AM - Pág. 69", text: "Indica la vía la que dan sus indicaciones las señales instaladas en lugar que puedan ofrecer duda. Se instalan en el mástil de las señales."},
]
var cambiaSigns = [
